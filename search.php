        ...
        <script>
            const error_texts = {
                not_enough_results: {
                    ...
                    , more_info: 'Alternatively you can <a id="more-info-link_na" class="underline" target="_blank">check out results for your search query on <span id="more-info-link_service"></span></a>'
                    , contact: 'If you think that there is something wrong with our service, please let us know at <br><a class="underline" href="mailto:info@openknowledgemaps.org">info@openknowledgemaps.org</a>. Make sure you include the search query in your message.'
                ...
                server_error: {
                    ...
                    , remedy: 'If the error persists, please let us know at <a class="underline" href="mailto:info@openknowledgemaps.org">info@openknowledgemaps.org</a>.'
                    , "resolution": "Try again"
                    , "resolution_link": "index"
                ...
                no_post_data: {
                    ...
                    , contact: 'If you think that there is something wrong with our service, please let us know at <br><a class="underline" href="mailto:info@openknowledgemaps.org">info@openknowledgemaps.org</a>'
