    ...
    <div id="more-info">
        ...
        <a target="_blank" href="https://openknowledgemaps.org/covis/">
            <div class="vision" style="min-height: 20px;">
                <img src="./img/integrations/covis.png" style="margin-bottom: 20px;" alt="">
        ...
        <a target="_blank" href="https://openknowledgemaps.org/viper">
            <div class="vision" style="min-height: 20px;">
                <img src="./img/integrations/viper.png" style="margin-bottom: 20px;" alt="">
        ...
        <a href="./projects">
            <div class="vision" style="min-height: 20px;">
                <img src="./img/integrations/all-projects.png" style="margin-bottom: 20px;" alt="">
