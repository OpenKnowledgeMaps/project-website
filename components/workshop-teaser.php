<div style="background-color: #eff3f4">
    <img class="mobile-img" src="./img/enthusiasts/workshop-teaser.png" alt='Pictures of Open Knowledge Maps workshops worldwide'>
</div>

<div class="landscape-teaser">
    <div class="landscape-teaser-text">
        <h2 class="h2reverse">Spread the word</h2>
