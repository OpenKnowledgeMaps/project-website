<div id="divhow" class="current-enthusiasts-bg" style="border-top: 1px solid #cacfd3;">
    <span class="anchor" id="current-enthusiasts"></span>
    <div class="faq">
        <h2 class="h2reverse">Our Enthusiasts</h2>

        <p style="text-align:center;">are Open Knowledge Maps power users and ambassadors from all over the world.

            They do not only run workshops and a variety of other activities 
            - they also help us shaping Open Knowledge Maps. 
        </p>
    </div>
        ...
        <div id="members"> 
            ...
            <div class="member">
                ...
                <ul>
                    ...
                    <li class="job-title">Law & Intellectual Property Librarian</li>
                    <li class="organization">University of Zimbabwe</li>
            ...
            <div class="member">
                ...
                <ul>
                    ...
                    <li class="job-title">Systems Librarian</li>
                    <li class="organization">The Nelson Mandela<br>
                        African Institution</li>
                    <li class="organization">of Science and Technology</li>
            ...
            <div class="member">
                ...
                <ul>
                    ...
                    <li class="job-title">PhD in Information Science</li>
                    <li class="country"><span class="awesome"><i class="fas fa-location-arrow"></i></span> Brazil</li>
                </ul>
            </div>
            ...
            <div class="member">
                ...
                <ul>
                    ...
                    <li class="job-title">Teacher at English Department</li>
                    <li class="organization">Universitas Islam Nusantara</li>
                    <li class="country"><span class="awesome"><i class="fas fa-location-arrow"></i></span> Indonesia</li>
                </ul>
            </div>
            ...
            <div class="member">
                ...
                <ul>
                    ...
                    <li class="job-title">Medical Doctor, Pathologist</li>
                    <li class="organization">Independent researcher</li>
            ...
            <div class="member">
                ...
                <ul>
                    ...
                    <li class="job-title">Lecturer & Researcher</li>
                    <li class="organization">Institut Teknologi Bandung</li>
                    <li class="country"><span class="awesome"><i class="fas fa-location-arrow"></i></span> Indonesia</li>
                </ul>
            </div>
            ...
            <div class="member">
                ...
                <ul>
                    ...
                    <li class="job-title">Senior Knowledge Transfer Officer</li>
                    <li class="organization">AquaTT</li>
                    <li class="country"><span class="awesome"><i class="fas fa-location-arrow"></i></span> Ireland</li>
                </ul>
            </div>
            ...
            <div class="member">
                ...
                <ul>
                    ...
                    <li class="organization">AfricArxiv</li>
                    <li class="country"><span class="awesome"><i class="fas fa-location-arrow"></i></span> Bénin</li>
                </ul>
            </div>
            ...
            <div class="member">
                ...
                <ul>
                    ...
                    <li class="job-title">Senior Information Officer</li>
                    <li class="organization">DTU Library</li>
                    <li class="country"><span class="awesome"><i class="fas fa-location-arrow"></i></span> Denmark</li>
                </ul>
            </div> 
            ...
            <div class="member">
                ...
                <ul>
                    ...
                    <li class="job-title">Software Engineer</li>
            ...
            <div class="member">
                ...
                <ul>
                    ...
                    <li class="organization">Max Planck Institute<br>for Psycholinguistics</li>
                    <li class="country"><span class="awesome"><i class="fas fa-location-arrow"></i></span> Netherlands</li>
                </ul>
            </div>
            ...
            <div class="member">
                ...
                <ul>
                    ...
                    <li class="organization">Humboldt-Institut<br>for Internet and Society</li>
                    <li class="country"><span class="awesome"><i class="fas fa-location-arrow"></i></span> Germany</li>
                </ul>
            </div>
