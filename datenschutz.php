        ...
        <div id="imprint">
            <div style="max-width: 750px; width:100%; margin: 0px auto;">
                ...
                <p>Open Knowledge Maps - Verein zur Förderung
                    ...
                    Gumpendorfer Straße 16/1/8, 1060 Wien, Österreich<br>
                    ZVR:
                    859648888<br>
                    E-Mail-Adresse:
                ...
                <p>Zur Verarbeitung von Spenden nutzen wir PayPal, einen Zahlungsabwicklungsservice von PayPal Inc. (dem Mutterkonzern von PayPal (Europe) S.à r.l. et Cie, S.C.A.), verortet in Kalifornien, USA. Mehr Informationen zu den von PayPal verarbeiteten Daten und PayPal's Datenschutzgrundsätzen finden sie hier
                ...
                <p>Achtung: Wenn Sie Ihre Cookies löschen, so hat dies zur Folge, dass auch das Opt-Out-Cookie gelöscht wird und ggf. von Ihnen erneut aktiviert werden muss.</p>
                ...
                <p>Wenn Sie sich für unseren Newsletter eintragen übermitteln Sie ihre persönlichen Daten (E-Mail-Adresse und Name) und geben uns das Recht Sie per E-Mail zu kontaktieren.
                    Wir nutzen die Daten um Sie in unregelmäßigen Abständen über die Verbesserungen unserer Services und andere Neuigkeiten des Vereins Open Knowledge Maps zu informieren.
                </p>
                <p>Die im Rahmen der Anmeldung zum Newsletter gespeicherten Daten nutzen wir ausschließlich für unseren Newsletter. Wir geben ihre Daten nicht an Dritte weiter.</p>
                <p>Sie können sich jederzeit von unserem Newsletter abmelden. Den Link dafür finden Sie in jedem Newsletter ganz unten.
                    Sollten Sie sich vom Newsletter abmelden, dann löschen wir alle Daten, die mit der Anmeldung zum Newsletter gespeichert wurden.</p>
                <p>Sie können jederzeit ihre bereitgestellten Daten einsehen und anpassen - Sie finden den Link dafür in jedem Newsletter ganz unten.</p>
                <p>Sie können uns aber auch direkt kontaktieren und Änderungen durch uns veranlassen.</p>
                ...
                <p>verwenden wir den DSGVO konformen Service MailChimp. Mailchimp ist ein automatisierter Marketing Service der The Rocket Science Group, LLC
