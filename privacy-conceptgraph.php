    ...
    <body id="imprint-page">
        ...
        <div id="imprint">
            <div style="max-width: 750px; width:100%; margin: 0px auto;">
               ...
               <p>If you do not consent to the storage and analysis of data on your visit to our website, you can block these actions at any time by clicking below. In such a case, an opt-out cookie will be stored on your device, meaning that Piwik will not collect session data from your visit.</p>
               ...
               <p>You can control and/or delete cookies as you wish – for details, see <a class="underline" target="_blank" href="https://aboutcookies.org">aboutcookies.org</a>. You can delete all cookies that are already on your computer and you can set most browsers to prevent them from being placed. If you do this, however, you may have to manually adjust some preferences every time you visit a site and some services and functionalities may not work as expected.</p>
                ...
                <p>More details regarding Google Hosted Libraries are available here:
                ...
                <ul style="list-style: disc; margin-left:20px;">
                  <li>Information to check if and which personal data we have stored about you</li>
                  <li>Correcting / completing your personal information that is incorrect or incomplete</li>
                  <li>Deletion of your personal data that is no longer (legally) compliant proceseed</li>
                  <li>Restriction of processing</li>
                  <li>Data portability</li>
                  <li>Free revocation of a given consent with effect for the future; i.e. the processing of the data concerned will be inadmissible from that date unless there is another justification</li>
                  <li>Right to objection to the extent that the joint controllers rely on an overriding legitimate interest</li>
                </ul>
