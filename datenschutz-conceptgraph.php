    ...
    <body id="imprint-page">
        ...
        <div id="imprint">
            <div style="max-width: 750px; width:100%; margin: 0px auto;">
                ...
                <h3>Gemeinsam Verantwortliche</h3>
                ...
                <p>Die gesammelten Daten umfassen</p>
                <ul style="list-style: disc; margin-left:20px;">
                  <li>Cookie-Information, um auf mehrfache Zugriffe des gleichen Benutzers schließen zu können (s. Cookies).</li>
                ...
                <p>Die Speicherung erfolgt bis zur Erschöpfung des Verarbeitungszwecks, es sei denn, es liegen darüber hinaus gesetzliche bzw (förder)vertragliche Aufbewahrungspflichten vor oder (überwiegende) berechtigte Interessen rechtfertigen eine längere Speicherung (zB zur Geltendmachung bzw Verteidigung von Rechtsansprüchen).
                </p>
                ...
                <ul style="list-style: disc; margin-left:20px;">
                    <li>Sicherstellung eines problemlosen Verbindungsaufbaus der Webseite
                    </li>
                ...
                <p>Weitergehende personenbezogene Daten wie Name, Adresse und E-Mail-Adresse werden nur erfasst, wenn Sie diese selbst angeben. Auf dieser Webseite können Sie diese Daten beispielsweise bei der Kontaktaufnahme angeben.
                </p>
                ...
                <p>Wenn Sie auf der Webseite auf einen E-Mail-Link  oder einen unserer anderen Kontakt Buttons klicken, wird ihre E-Mail Software aktiviert und Sie können eine Nachricht an uns verfassen und an eine spezifische Mailbox senden.</p>
                ...
                <h3>Cookies</h3>
                <p>Damit diese Webseite ordnungsgemäß funktioniert, legen wir manchmal kleine Dateien – sogenannte Cookies – auf Ihrem Gerät ab. Das ist bei den meisten großen Webseiten üblich.
                </p>
                ...
                <ul style="list-style: disc; margin-left:20px;">
                    ...
                    <li>zur Erstellung von aggregierten Nutzungsstatistiken</li>
                    <li>zur anonymisierten Analyse des Nutzungsverhaltens</li>
                </ul>
                ...
                <p>Achtung: Wenn Sie Ihre Cookies löschen, so hat dies zur Folge, dass auch das Opt-Out-Cookie gelöscht wird und ggf. von Ihnen erneut aktiviert werden muss.
                </p>
                ...
                <p>Zusätzlich oder als Alternative zum Browser-Add-On können Sie das Tracking durch Google Analytics auf unseren Seiten unterbinden, indem Sie diesen Link [ javascript:gaOptout() ]  anklicken. Dabei wird ein Opt-out-Cookie auf Ihrem Gerät installiert. Damit wird die Erfassung durch Google Analytics für diese Website und für diesen Browser zukünftig verhindert, so lange das Cookie in Ihrem Browser installiert bleibt.
                </p>
                ...
                <p>Weitere Details bezüglich Google Analytics finden Sie hier:
                     <a class="underline" target="_blank" href="https://support.google.com/analytics/answer/6004245">https://support.google.com/analytics/answer/6004245</a>
                      </p>
